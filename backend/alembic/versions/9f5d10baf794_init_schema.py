...
Revision ID: 9f5d10baf794
Revises: 
Create Date: 2026-06-10 18:56:16.246392
...
def upgrade() -> None:
    ...
    sa.Column('market', sa.String(length=96), nullable=False),
    ...
    sa.Column('competition', sa.String(length=96), nullable=False),
    ...
    sa.Column('book', sa.String(length=96), nullable=False),
    ...
    sa.Column('pos', sa.String(length=8), nullable=False),
    sa.Column('club', sa.String(length=128), nullable=False),
